...
public:
  Producto(
      std::string _nombre, std::vector<int> _siembra, std::vector<int> _venta,
      double _cosecha, short _unit, double _rendimiento, double _vol_feriante,
      double _vol_cons, double _prob_cons, double _precio_feria
  );
