...
class ParallelSimulation; // Forward declaration

using EventHandlerFunc = std::function<void(ParallelSimulation *, Event *)>;
...
public:
  ...
  // Handle an event
  void handle(ParallelSimulation *sim, Event *e)
  {
